...
die("Server Could Not Connected");
  if(isset($_POST["mpdt"])){
    ...
    if(move_uploaded_file($temp,"Product_Image/".$name)){
      $update="update product_detail set Product_Img='".$name."',Product_Price='".$price."',Product_discr='".$disc."',Product_Name='".$pname."' where Product_Id='".$id."'";
      $no=mysqli_query($con,$update);
      if($no!=0){
        echo"record is Modified";
      }else{
        echo"Unable to Modified";
      }
    }
  }
    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="modify_product.php">Modify Product</a></li>
...
<!-- nav bar end -->
  ...
  <main id="main" class="container-fluid col-lg-6 col-md-6 col-xs-4 mb-5 mt-10">
      <h3 class="mx-auto mt-3" style="width: 200px;">Modify Product</h3>
    <form action="<?php $_PHP_SELF?>" method="post" enctype="multipart/form-data">
    <div class="form-group">
          <label for="exampleInputPassword1">Product Id</label>
          <input type="text" class="form-control" id="exampleInputPassword1" name="pid" placeholder="Enter Product Id to modify product detail" required>
        </div>
        <div class="form-group">
     ...
     <div class="form-group">
        ...
        <button type="submit" class="btn btn-primary" name="mpdt" value="Add product">Modify Product</button>
      </form>
  </main><!-- End #main -->
