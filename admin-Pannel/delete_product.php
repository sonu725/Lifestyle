...
die("Server Could Not Connected");
  ...
  if(isset($_POST["dpdt"])){
      ...
      header("location: delete_product.php?error=1");
      }
?>
<!DOCTYPE html>
<html lang="en">
...
<header id="header" class="fixed-top ">
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="delete_product.php">Delete Product</a></li>
  ...
  <main id="main" class="container-fluid col-lg-6 col-md-6 col-xs-4 mb-5 mt-8">
      <h3 class="mx-auto mt-3" style="width: 200px;">Delete Product</h3>
    ...
    <div class="form-group">
        ...
        <button type="submit" class="btn btn-primary" name="dpdt" value="Add product">Delete Product</button>
        <?php 
        
        if(isset($_REQUEST["errot"])==1)
        echo '<div><h5>Unable to delete </h5></div>' ;
        ?>
      </form>
  </main><!-- End #main -->
