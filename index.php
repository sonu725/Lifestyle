      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <?php
            ...
            if(($_SESSION["Email"])==("alexsonu7654@gmail.com")){
              echo'<li><a href="admin-Pannel/admin.php">Admin Login</a></li>';
            }
            }else{
              echo'<li><a href="#" data-toggle="modal" data-target="#exampleModalCenter">Login</a></li>';
              echo'<li><a href="user_signup.php">Sign Up</a></li>';
              echo'<li><a href="admin-Pannel/login.php">Admin Login</a></li>';
            }
  ...
  <section id="hero" class="d-flex justify-cntent-center align-items-center">
    ...
    <?php
           while($data=mysqli_fetch_assoc($rs)){
             ...
             if(isset($_SESSION["Email"])){
             echo'
             <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5" data-aos="fade-up">
             ...
             <div class="card-body">
              <div>
               ...
               <div><h6>'.$disc.'</h6></div>
               <div><h5>Price: Rs '.$price.'</h5></div>
               <a href="Product_bill.php?id='.$id.'" class="btn btn-primary">Buy Now</a>
             </div>
           </div>
           </div>';
             }else{
              ...
              <div class="card-body">
               <div>
                ...
                <div><h6>'.$disc.'</h6></div>
                <div><h5>Price: Rs '.$price.'</h5></div>
                <a href="#" data-toggle="modal" data-target="#exampleModalCenter" class="btn btn-primary">Buy Now</a>
              </div>
            </div>
            </div>';
             }
